...
import { Mail, UserCircle, Calendar, ShoppingBag, BookOpen } from "lucide-react"
        ...
        <div className="space-y-6">
          <div className="flex flex-col items-center gap-3">
            {user.imageUrl ? (
              ...
              <div className="size-20 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center">
